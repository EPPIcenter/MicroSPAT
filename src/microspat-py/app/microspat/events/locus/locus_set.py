...
from ..base import base_list, base_get, table_to_string_mapping, make_namespace, TaskNotifier, base_get_updated
...
socketio.on_event('get_updated', base_get_updated(LocusSet, schema, schema, JSON_NAMESPACE), namespace=SOCK_NAMESPACE)
