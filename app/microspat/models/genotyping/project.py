...
from ..sample.genotype import Genotype
...
from app.microspat.peak_annotator.PeakFilters import compose_filters, bin_filter, flags_filter, probability_filter
from app.microspat.statistics import calculate_allele_frequencies, calculate_moi, calculate_prob_negative, \
    calculate_prob_pos_if_observed
...
class GenotypingProject(SampleBasedProject, ArtifactEstimating, QuantificationBiasEstimating, BinEstimating):
    ...
    def artifact_estimator_changed(self, locus_id):
        super(GenotypingProject, self).artifact_estimator_changed()
        self.initialize_alleles(locus_id)

    def quantification_bias_estimator_changed(self, locus_id):
        super(GenotypingProject, self).quantification_bias_estimator_changed()
