import { Component, ChangeDetectionStrategy, OnChanges, Input, Output, EventEmitter, SimpleChange, SimpleChanges } from '@angular/core';
    ...
    <mat-card>
      ...
      <mat-card-content>
        <form [formGroup]="locusForm">
          ...
          <mat-form-field class="half-width" [floatLabel]="'always'">
            <mat-label>Nucelotide Repeat Length</mat-label>
      ...
      <mat-card-actions>
      <button mat-raised-button *ngIf="!locus" [disabled]="this.locusForm.invalid" color="primary" (click)="submitPressed()">SUBMIT</button>
      <button mat-raised-button *ngIf="locus" color="warn" (click)="deletePressed()">DELETE</button>
